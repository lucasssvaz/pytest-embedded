...
def _listen(q: MessageQueue, filepath: str, with_timestamp: bool = True, count: int = 1, total: int = 1, _stdout_lock=None) -> None:
...
def _listener_gn(msg_queue, _pexpect_logfile, with_timestamp, dut_index, dut_total, _stdout_lock=None) -> multiprocessing.Process:
    ...
    def create(
        ...
        *,
        ...
        try:
            ...
            _listener = _listener_gn(msg_queue, _pexpect_logfile, True, DUT_GLOBAL_INDEX, DUT_GLOBAL_INDEX + 1, _stdout_lock=_STDOUT_LOCK)
